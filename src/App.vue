...
<style lang="postcss" scoped>
  main {
    ...
    .title {
      @apply m-2 text-7xl font-bold tracking-wider text-redish;
    }
    ...
    form {
      ...
      button {
        @apply bg-accent text-background p-2 text-2xl rounded-r-md;
        &:hover{
    ...
    ul {
      @apply flex flex-col items-center justify-center rounded-lg bg-redish;
      li {
